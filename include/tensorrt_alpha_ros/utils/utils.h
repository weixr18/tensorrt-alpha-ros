...
#ifndef TENSORRT_ALPHA_ROS_UTILS_H
#define TENSORRT_ALPHA_ROS_UTILS_H
...
namespace utils 
{
    ...
    *************************************************************************************************/
    ...
    void drawBboxes(const std::vector<std::vector<Box>>& objectss, const std::vector<std::string>& classNames,
...
#endif // TENSORRT_ALPHA_ROS_UTILS_H