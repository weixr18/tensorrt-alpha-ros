...
YOLOV5::YOLOV5(const utils::InitParameter& param):YOLO(param)
{
}
...
void YOLOV5::setParameters(utils::InitParameter& initParameters)
{
...
void YOLOV5::task(const utils::InitParameter& param, std::vector<cv::Mat>& imgsBatch, 
