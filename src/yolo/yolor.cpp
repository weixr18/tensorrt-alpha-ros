...
YOLOR::YOLOR(const utils::InitParameter& param) : YOLO(param)
{
}
...
void YOLOR::setParameters(utils::InitParameter& initParameters)
{
...
void YOLOR::task(const utils::InitParameter& param, std::vector<cv::Mat>& imgsBatch, const int& delayTime, const int& batchi,
